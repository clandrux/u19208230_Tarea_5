...
class cCaptcha {
	...
	var $text_color = '003357'; // hex string
	var $noise_color = '64A0C8'; // hex string
	var $width = 200; // P61
	var $height = 50; // P61
	var $characters = 6;
	var $font_size = 25;
	var $image_type = IMG_JPG;
	...
	function GenerateCode($characters) {
		$possible = 'BCDFGHJKMNPQRSTVWXYZ'; // possible characters // P61
		$code = '';
		$i = 0;
		while ($i < $characters) {
