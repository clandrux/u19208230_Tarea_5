...
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/theme-default.css"); // "phpcss/php_stock.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "root", "db" => "phpstockdb", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("es", "", "indonesian_phpstock.xml");
